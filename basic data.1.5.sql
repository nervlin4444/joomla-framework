...
--
-- 列出以下資料庫的數據： `jos_contact_details`
--
...
--
-- 列出以下資料庫的數據： `jos_content_frontpage`
--
...
--
-- 列出以下資料庫的數據： `jos_core_acl_aro_groups`
--
...
--
-- 列出以下資料庫的數據： `jos_core_acl_aro_map`
--
...
--
-- 資料表格式： `jos_core_acl_aro_sections`
--
...
--
-- 列出以下資料庫的數據： `jos_core_acl_aro_sections`
--
...
--
-- 資料表格式： `jos_core_acl_groups_aro_map`
--
...
--
-- 列出以下資料庫的數據： `jos_core_acl_groups_aro_map`
--
...
--
-- 列出以下資料庫的數據： `jos_core_log_searches`
--
...
--
-- 列出以下資料庫的數據： `jos_migration_backlinks`
--
...
--
-- 列出以下資料庫的數據： `jos_users`
--

INSERT INTO `jos_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `gid`, `registerDate`, `lastvisitDate`, `activation`, `params`) VALUES
(62, 'Administrator', 'admin', 'nerv_lin@yahoo.com.hk', '070c6ac7195f9ee40c9c0d1265ac75c8:04DWggWDT2vI2KgGFfAoWOpD3cS2aiwW', 'Super Administrator', 0, 1, 25, '2010-04-09 07:57:27', '0000-00-00 00:00:00', '', '');
